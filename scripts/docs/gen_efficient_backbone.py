...
BODY = r"""
  ...
  <section>
    ...
    <p>
      <a href="nas.html"><strong>NAS</strong></a>(신경망 구조 탐색)가 이 일을 자동화한다.
  ...
  <section>
    ...
    <p>
      ...
      마지막에 양자화한다.</strong> 양자화가 부족하면 <a href="calibration.html">캘리브레이션</a>을
      조정하고, 그래도 안 되면 <a href="qat.html">QAT</a> 로 올라간다. 양자화가 마지막인 이유는 사후 적용이 가능하고
      효과가 가장 확실하기 때문이다.
    </p>
    <div class="note">
      <b>경량 구조와 양자화는 충돌하기도 한다.</b>
      depthwise 층은 채널별 분포 편차가 커서 <a href="ondevice-quantization.html"><em>채널 단위 양자화</em></a>가 아니면
