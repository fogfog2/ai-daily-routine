...
BODY = r"""
  ...
  <section>
    ...
    <p>
      카메라는 센서의 RAW 데이터를 <a href="isp-pipeline.html">여러 단계</a>(디모자이킹·화이트밸런스·<a href="hdr-tone-mapping.html">톤매핑</a>·압축)를 거쳐
    ...
    <p>
      ...
      실제로 스마트폰의 야간 촬영과 <a href="hdr-tone-mapping.html">HDR 합성</a>은 대부분 이 방식이다.
