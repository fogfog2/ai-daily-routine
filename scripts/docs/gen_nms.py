...
BODY = r"""
  ...
  <section>
    ...
    <p>
      ...
      같은 척도를 <a href="iou-losses.html">학습 손실로 쓰는 계보</a>가 따로 있는데,
      거기서는 이 함수의 <em>평지</em>가 문제가 된다 — 겹치지 않으면 값이 움직이지 않는다.
    </p>
    <div class="eq">
  ...
  <section>
    ...
    <p>
      ...
      이 중심 거리 항은 원래 <a href="iou-losses.html">DIoU 손실</a>에서 나왔다 —
      학습 손실로 만든 기하를 후처리 규칙에 그대로 옮긴 것이다.
    </p>
    <div class="note">
